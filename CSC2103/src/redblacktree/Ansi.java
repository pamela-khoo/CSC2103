...
import java.util.List;
 ...
 /**
 *  Color the console output with ANSI escape sequences
 *
...
public class Ansi {
	...
	public void colorNode(char color, int node) {
		if (color == 'R') {
			String redNode = Ansi.HIGH_INTENSITY + Ansi.BACKGROUND_RED + Ansi.WHITE + " " + node + " " + RESET;
			System.out.println(redNode);
		}
		else {
			String blackNode = Ansi.HIGH_INTENSITY + Ansi.BACKGROUND_BLACK + Ansi.WHITE + " " + node + " " + RESET;
			System.out.println(blackNode);
		}
	}
}
